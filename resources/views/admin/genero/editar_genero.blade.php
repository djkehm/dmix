                ...
                <div class="card-body alpha">
                    ...
                    <form method="POST" action="{{route('generos.update', $genero->id)}}">
                        ...
                        <div class="mb-4 form-group">
                            ...
                            <input type="text" id="nombreGe" name="nombreGe" value= '{{$genero->nombreGe}}'class="form-control" placeholder="Nombre del Genero">
                        </div>
                        

                        <div class="card-footer d-grid gap-1 mb-4 text-center">
                            <button id="registrar-btn" class="btn btn-outline-info text-center" type="submit">Editar Genero</button>
                        </div>
                    </form>
                    </div>
